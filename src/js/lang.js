...
var arrLang = {
  ...
  ru: {
    ...
    contacts: 'Контакти',
    phone: 'Телефон',
    mainherotitle: 'Інженерна, конструкторська та дизайнерська робота',
    mainherotext: 'Ми втілюємо ідеї в реальність',
    maingallerytitle: 'ГАЛЕРЕЯ',
    maingallerytext1: 'Інженерні методи аналізу та контролю якості',
    maingallerytext2: 'Високоточне 3D сканування',
    maingallerytext3:
      'Створення точної копії на базі сканування reverse engineering',
    maingallerytext4:
      'Всі цикли 3D проектування, створення фотореалістичних цифрових моделей',
    mainmorephototitle: 'БІЛЬШЕ ФОТО',
  },
};
