...
function highlightMenuLink() {
    ...
    for (const menuLink of allMenuLinks){
        ...
        if (currentPathName === pathname) menuLink.classList.add("mobile-menu__link--current");
        else menuLink.classList.remove("mobile-menu__link--current");
    }
}
highlightMenuLink();
...
//# sourceMappingURL=3d-modeling.975ef6c8.js.map
